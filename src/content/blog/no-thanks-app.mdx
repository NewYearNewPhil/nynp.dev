...
## Update: Better Version of this exists
I've stumbled upon [AdAid](https://github.com/NikLeberg/AdAid) by [NikLeberg](https://github.com/NikLeberg) which is more generic implementation of a similar idea. I recommend using it instead of my app, especially once my [PR](https://github.com/NikLeberg/AdAid/pull/36) has been merged.
